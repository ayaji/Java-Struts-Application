			...
			/* 	
				...
				if(reviewsMap != null){
					...
					for (Review review : reviewsArrList) {               	
						...
						out.println("<tr>");
						out.println("<th colspan=\"2\" style=\"font-size:18px\">"+review.getProductRvS()+"</th>");
						out.println("</tr>");
						out.println("<tr>");
						...
						out.println("<tr>");
						out.println("<td>");
						out.println("<img src=\"images/"+review.getProductRvR()+".png\"/>&nbsp;&nbsp;&nbsp;<span style=\"font-size:36px;font-weight: bold\">"+review.getProductRvR()+"</span>");
						out.println("</td>");
						out.println("<td>");
						out.println("Reviewed on:<br/>");
				...
				if(reviewsMap != null){
					...
					for (Review review : reviewsArrList) {               	
						...
						out.println(review.getProductRvU()+" rated<img src=\"images/star4.jpg\"/>&nbsp;&nbsp;&nbsp;<span style=\"font-size:36px;font-weight: bold\">"+review.getProductRvR()+"</span>");
						out.println("<br>");
						//out.println("<td>");
