...
public class PhoneProducts extends HttpServlet {
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{	
			...
			PrintWriter out = response.getWriter();
					...
					out.println("<tr>");
					out.println("<td>");
					out.println("<h1 style=\"color: #d37639;border-bottom: 2px solid #777;float: center\">Smart Phones</h1>");
					out.println("</td>");
					out.println("</tr>");
					out.println("</table>");
			...
			for (Map.Entry<String, Product> entry : pMap.entrySet()) {
				...
				if(product.getDisplayUnder().equalsIgnoreCase("phoneproducts")){
