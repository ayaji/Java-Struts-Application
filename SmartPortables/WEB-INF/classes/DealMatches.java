...
out.println("<head>");
	...
	out.println("<tr>");
	out.println("<td>");
	out.println("<h1 style=\"color: #d37639;border-bottom: 2px solid #777;float: center\">Deal Matches</h1>");
	out.println("</td>");
	out.println("</tr>");
	out.println("</table>");
	...
	if(dealMatchProducts.size()<2 && !dealMatchProducts.containsKey(entry.getKey())){				
		...
		if(line==null){ 
			...
			out.println("<td align=\"center\" style=\"width:100%;padding: 0px;\">");
			out.println("<p style=\"font-size:27px;font-weight:bold;color:Red;padding: 0px;line-height: 110%;\">");
			...
			do{
				...
				if(line.contains(product.getName())){					
					...
					out.println("<tr style=\"padding: 0px;\">");
					out.println("<td align=\"center\" style=\"width:50%;padding: 0px;\">");
					out.println("<p style=\"font-size:22px;font-weight:bold;color:black;padding: 0px;line-height: 110%;\">");
					out.println(product.getName()+" "+product.getDescription());
					out.println("</p>");
					out.println("</td>");
					out.println("<td align=\"center\" style=\"width:50%;padding: 0px;\">");
					out.println("<p style=\"font-size:22px;font-weight:bold;color:black;padding: 0px;\">");
					out.println("Deal From Our Local Competitor:");
					out.println("</p>");
					out.println("</td>");
					out.println("</tr>");
					out.println("<tr style=\"padding: 0px;\">");
					out.println("<td style=\"width:50%;padding: 0px;\" >");
					out.println("<table class=\"wrapper\">");
					out.println("<tr>");
					out.println("<td>");		
					out.println("<img src=\""+product.getImageUrl()+"\" height=\"260px\" width=\"280px\"/>");
					out.println("</td>");
					out.println("<td >");				
					out.println("<h2>");
					out.println("Buy New");
					...
					out.println("<h3>");
					out.println("<em>$</em>");
					out.println("<span style=\"font-size:26px;font-weight:bold;color:black\">"+product.getPrice()+"<span>");
					out.println("</h3>");
					out.println("<br/>");
					out.println("<br/>");
					out.println("<button onclick=\"location.href='storetoshoppingcart?product_id="+product.getId()+"&requestFrom=showProduct'\" class=\"sign-in-up-button\" style=\"width:158px\">&nbsp;&nbsp;Buy&nbsp;</button>");
					out.println("<br/>");
					out.println("<br/>");
					if(session == null){
						out.println("<button onclick=\"location.href='login.html'\" class=\"sign-in-up-button\" style=\"width:158px\">Write Review</button>");
					}
					else{
						session.setAttribute("itemId", product.getId());	
						out.println("<button onclick=\"location.href='userreview.html'\" class=\"sign-in-up-button\" style=\"width:158px\">Write Review</button>");
					}
					out.println("<br/>");
					out.println("<br/>");
					out.println("<button onclick=\"location.href='showproductinfo?product_id="+product.getId()+"'\" class=\"sign-in-up-button\" style=\"width:158px\">View Reviews</button>");
					out.println("</td>");
					out.println("<td style=\"border-right: double #888;\"></td>");
					out.println("</tr>");
					out.println("</table>");	
					out.println("</td>");
					out.println("<td style=\"width:50%;\">");
					out.println("<p style=\"font-size:19px;font-weight:bold;line-height: 110%;text-align: justify\">"+line+"</p>");
					out.println("</td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td colspan=\"3\" style=\"border-bottom: double #888;\"></td>");
					out.println("</tr>");
					out.println("<tr>");
