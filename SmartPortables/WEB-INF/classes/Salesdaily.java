...
public class Salesdaily extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			Map<String,Product> pMap = MySQLDataStoreUtilities.getsalesdaily();
				...
				out.println(" <li class=\"mainmenu\"><a href=\"addnewaccessory.html\">Add New Accessory</a></li>");
					...
					out.println("<h1 style=\"color: #d37639;border-bottom: 2px solid #777;\">Daily Sale Details</h1>");
					out.println("</td>");
					...
					out.println("<span style=\"font-size:24px;font-weight: bold\">Order Date</span>");
					out.println("</th>");
					out.println("<th align=\"center\" width=\"50%\">");
					out.println("<span style=\"font-size:24px;font-weight: bold\">Product</span>");
					out.println("</th>");
					out.println("<th align=\"center\" width=\"50%\">");
					out.println("<span style=\"font-size:24px;font-weight: bold\">Items Sold</span>");
					out.println("</th>");
					out.println("</tr>");
					out.println("</table>");
					...
					if(pMap != null){
						if(pMap.isEmpty()){
							...
							for (Map.Entry<String,Product> entry : pMap.entrySet()) {
								...
								out.println("<span style=\"font-size:20px;font-weight: bold\">"+product.getImageUrl()+"</span>");				   
								out.println("</td>");
