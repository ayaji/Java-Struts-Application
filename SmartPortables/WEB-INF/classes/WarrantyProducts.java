...
public class WarrantyProducts extends HttpServlet {
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{	
			...
			PrintWriter out = response.getWriter();
					...
					out.println("<tr>");
					out.println("<td>");
					out.println("<h1 style=\"color: #d37639;border-bottom: 2px solid #777;\">Warranty</h1>");
					out.println("</td>");
					out.println("</tr>");
					out.println("</table>");
					out.println("<div class=\"displaylist\">");
			for (Map.Entry<String, Warranty> entry : wMap.entrySet()) {
				Warranty warranty = entry.getValue();			
						
					
					
					out.println("<ul>");
					out.println("<li>");
					out.println("<a href=\"showwarrantyinfo?warranty_id="+warranty.getId()+"\"><img src=\"images/noimage.png\" height=\"140px\" width=\"155px\">");
					out.println("<br/>");
					out.println("<br/>");
					out.println("<span style=\"font-weight: bold;font-size:16px;text-align: center\">");
					out.println(warranty.getName()+" "+warranty.getDescription()+"<br/>");
					out.println("<br/>");
					out.println("</span>");
