...
public class Salesgraph extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			Map<String,Product> pMap = MySQLDataStoreUtilities.getProductssalesgraph();
...
out.println("      ['Category', 'Items Sold'],");
...
out.println("      chart: {                                                                                 ");
out.println("        title: 'Sales Details',                                                            ");
out.println("      },                                                                                       ");
out.println("      bars: 'horizontal', // Required for Material Bar Charts.                                 ");
out.println("      series: {                                                                                ");
out.println("        0: { axis: 'distance' }, // Bind series 0 to an axis named 'distance'.                 ");
out.println("        //1: { axis: 'brightness' } // Bind series 1 to an axis named 'brightness'.            ");
out.println("      },                                                                                       ");
out.println("      axes: {                                                                                  ");
out.println("        x: {                                                                                   ");
out.println("          distance: {label: 'No. of Items'}, // Bottom x-axis.                                 ");
out.println("         // brightness: {side: 'top', label: 'apparent magnitude'} // Top x-axis.              ");
out.println("        }                                                                                      ");
out.println("      }                                                                                        ");
out.println("    };                                                                                         ");
