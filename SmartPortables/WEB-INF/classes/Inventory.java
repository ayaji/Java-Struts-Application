		...
		try{
			...
			//pMap =  MySQLDataStoreUtilities.getProductsinventory();
				...
				out.println(" <li class=\"mainmenu\"><a href=\"addnewaccessory.html\">Add New Accessory</a></li>");
					...
					//out.println("<tr>");
					out.println("<th align=\"center\" width=\"50%\">");
					out.println("<span style=\"font-size:24px;font-weight: bold\">Price</span>");
					out.println("</th>");
					out.println("<th align=\"center\" width=\"50%\">");
					out.println("<span style=\"font-size:24px;font-weight: bold\">Item Count</span>");
					out.println("</th>");
					out.println("</tr>");
					out.println("</table>");
					...
					if(pMap != null){
						if(pMap.isEmpty()){
							...
							for (Map.Entry<String,Product> entry : pMap.entrySet()) {
								...
								out.println("<span style=\"font-size:20px;font-weight: bold\">"+product.getPrice()+"</span>");						
								out.println("</td>");
								out.println("<td align=\"center\" width=\"50%\">");	
