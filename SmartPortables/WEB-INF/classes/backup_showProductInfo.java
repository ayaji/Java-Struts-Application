...
public class ShowProductInfo extends HttpServlet {
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{				
			...
			out.println("<link rel=\"stylesheet\" href=\"shashank.css\" type=\"text/css\"/>");
			...
			out.println("<header>");
			out.println("<div style=\"color:#000\">");
			if(session==null){
				out.println("<h1><a href=\"Index.html\">Smart <span> Portables</span></a></h1><br>");
			}
			else{
				String userTypeInfo = (String)session.getAttribute("userTypeInfo");
				if(userTypeInfo.equalsIgnoreCase("Customer")){
					out.println("<h1><a href=\"validlogin.html\">Smart <span> Portables</span></a></h1><br>");
				}
				else{
					out.println("<h1><a href=\"salesmanvalidlogin.html\">Smart <span> Portables</span></a></h1><br>");
				}
			}
				...
				if(session==null){
					out.println("<li >");
					out.println("<a href=\"#\" style=\"width: 90px; text-align: center;\">Sign In&nbsp;<img  src=\"images/content/arrowdown.png\" width=\"18px\" height=\"13px\"/></a>");
					out.println("<ul>");
				...
				out.println("<li class=\"mainmenu\"><a href=\"smartwatchproducts\">Smart Watches</a></li>");
					...
					out.println("<li class=\"mainmenu\"><a href=\"storageproducts\">External Storage</a></li>");;
			    if(session!=null){
			    	String userTypeInfo = (String)session.getAttribute("userTypeInfo");
