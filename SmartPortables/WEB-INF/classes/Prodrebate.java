	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			//pMap =  MySQLDataStoreUtilities.getProductsinventory();
					...
					if(session==null){
					 ...
					 /* else{
						...
						if(userTypeInfo.equalsIgnoreCase("Customer")){
							out.println("<h1><a href=\"validlogin.html\">Samrt <span> Portables</span></a></h1><br>");
						} 
						else{
							out.println("<h1><a href=\"storemanager.html\">Smart <span> Portables</span></a></h1><br>");
						}
					}   */
					...
					out.println("<h1 style=\"color: #d37639;border-bottom: 2px solid #777;\">Product Inventory Details</h1>");
					out.println("</td>");
					...
					out.println("<br/>");
					out.println("<br/>");
					/* out.println("<h3 style=\"font-weight: bold\">PRODUCT DETAILS</h3>");  */
					out.println("<div >");
					...
					out.println("</th>");
					out.println("<th align=\"center\" width=\"50%\">");
					out.println("<span style=\"font-size:24px;font-weight: bold\">Rebate Amount</span>");
					out.println("</th>");
					out.println("</tr>");
					out.println("</table>");
					...
					if(pMap != null){
						if(pMap.isEmpty()){
							...
							for (Map.Entry<String,Product> entry : pMap.entrySet()) {
								...
								out.println("<table style=\"font-size:14px; width:80%;color:#777\">");			    
								out.println("<tr>");
								out.println("<td  width=\"50%\">");
								out.println("<span style=\"font-size:20px;font-weight: bold\">"+product.getName()+"</span>");				   
								out.println("</td>");
								 out.println("<td align=\"center\" width=\"50%\">");	
								out.println("<span style=\"font-size:20px;font-weight: bold\">"+product.getRebateAmt()+"</span>");						
								out.println("</td>");
								/*out.println("<td align=\"center\" width=\"50%\">");	
								out.println("<span style=\"font-size:20px;font-weight: bold\">"+product.getProdcount()+"</span>");						
								out.println("</td>");	 */								
								out.println("</tr>");               
								out.println("</table>");
							}
