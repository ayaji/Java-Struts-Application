...
function doCompletion(searchTxt) {
	var url = "autocomplete?action=findMatch&searchText="+searchTxt;
	req = initRequest();
...
function appendProduct(productName,productId) {
	...
	linkElement.setAttribute("href", "autocomplete?action=lookup&productId="+productId);
