...
public class AccessoryInformation extends HttpServlet {
...
for (Map.Entry<String, Accessory> entry : accessories.entrySet()) {
	Accessory accessory = entry.getValue();
				...
				out.println("<ul>");
					...
					out.println("<a href=\"showaccessoryinfo?accessory_id="+accessory.getId()+"&product_id="+product_id+"\"><img src=\""+accessory.getImageUrl()+"\"height=\"140px\" width=\"155px\">");
