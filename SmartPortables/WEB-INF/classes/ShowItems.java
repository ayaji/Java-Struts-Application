...
out.println("</li>"); 
					...
					if(session.getAttribute("currentShoppingCartItems")==null){
					    ...
					    out.println("<p>Add some items...</p>");
					    out.println("</td>");
					    out.println("</tr>");
					    out.println("</table>");
					    out.println("</div>");				
					...
					out.println("</tr>");
					out.println("</table>");
					  out.println("<h3>People also bought one of the following products with this product:</h3>");
					  out.println("</br>");
					  Carousel c = new Carousel();
					ProductUtility u = new ProductUtility();
					out.println(c.carouselfeature(u, session));
					out.println("</table>");
					out.println("</div>");	
